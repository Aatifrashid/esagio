    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div class="xl:col-span-2 space-y-4">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm"
                ...
                @php
                    $toothHotspots = [
                        '18' => ['left' => '5.11%', 'top' => '0.0%', 'width' => '5.84%', 'height' => '40.08%'],
                        '17' => ['left' => '12.04%', 'top' => '0.0%', 'width' => '5.84%', 'height' => '40.08%'],
                        '16' => ['left' => '19.34%', 'top' => '0.0%', 'width' => '6.93%', 'height' => '41.03%'],
                        '15' => ['left' => '26.64%', 'top' => '0.0%', 'width' => '4.38%', 'height' => '40.08%'],
                        '14' => ['left' => '31.24%', 'top' => '0.0%', 'width' => '4.01%', 'height' => '40.08%'],
                        '13' => ['left' => '35.62%', 'top' => '0.0%', 'width' => '3.5%', 'height' => '41.03%'],
                        '12' => ['left' => '39.27%', 'top' => '0.0%', 'width' => '3.07%', 'height' => '40.08%'],
                        '11' => ['left' => '42.48%', 'top' => '0.0%', 'width' => '3.8%', 'height' => '41.03%'],
                        '21' => ['left' => '46.57%', 'top' => '0.0%', 'width' => '3.5%', 'height' => '41.03%'],
                        '22' => ['left' => '50.36%', 'top' => '0.0%', 'width' => '3.07%', 'height' => '40.08%'],
                        '23' => ['left' => '53.65%', 'top' => '0.0%', 'width' => '3.8%', 'height' => '41.03%'],
                        '24' => ['left' => '57.66%', 'top' => '0.0%', 'width' => '4.38%', 'height' => '40.08%'],
                        '25' => ['left' => '62.41%', 'top' => '0.0%', 'width' => '4.38%', 'height' => '40.08%'],
                        '26' => ['left' => '67.88%', 'top' => '0.0%', 'width' => '7.3%', 'height' => '41.03%'],
                        '27' => ['left' => '75.91%', 'top' => '0.0%', 'width' => '6.93%', 'height' => '40.08%'],
                        '28' => ['left' => '83.58%', 'top' => '0.0%', 'width' => '8.76%', 'height' => '40.08%'],
                        '48' => ['left' => '4.74%', 'top' => '55.34%', 'width' => '6.2%', 'height' => '34.35%'],
                        '47' => ['left' => '11.68%', 'top' => '55.34%', 'width' => '5.84%', 'height' => '34.35%'],
                        '46' => ['left' => '18.61%', 'top' => '55.34%', 'width' => '6.93%', 'height' => '34.35%'],
                        '45' => ['left' => '26.13%', 'top' => '55.34%', 'width' => '4.53%', 'height' => '33.4%'],
                        '44' => ['left' => '31.02%', 'top' => '55.34%', 'width' => '4.01%', 'height' => '33.4%'],
                        '43' => ['left' => '35.4%', 'top' => '55.34%', 'width' => '3.5%', 'height' => '34.35%'],
                        '42' => ['left' => '39.12%', 'top' => '55.34%', 'width' => '2.92%', 'height' => '33.4%'],
                        '41' => ['left' => '42.19%', 'top' => '55.34%', 'width' => '3.07%', 'height' => '33.4%'],
                        '31' => ['left' => '45.4%', 'top' => '55.34%', 'width' => '3.07%', 'height' => '33.4%'],
                        '32' => ['left' => '48.76%', 'top' => '55.34%', 'width' => '3.28%', 'height' => '33.4%'],
                        '33' => ['left' => '52.26%', 'top' => '55.34%', 'width' => '4.01%', 'height' => '34.35%'],
                        '34' => ['left' => '56.64%', 'top' => '55.34%', 'width' => '4.53%', 'height' => '33.4%'],
                        '35' => ['left' => '61.68%', 'top' => '55.34%', 'width' => '4.53%', 'height' => '33.4%'],
                        '36' => ['left' => '67.01%', 'top' => '55.34%', 'width' => '7.3%', 'height' => '34.35%'],
                        '37' => ['left' => '75.18%', 'top' => '55.34%', 'width' => '6.93%', 'height' => '34.35%'],
                        '38' => ['left' => '83.07%', 'top' => '55.34%', 'width' => '8.76%', 'height' => '34.35%'],
                    ];
                @endphp

                <div class="relative w-full" style="max-width: 700px; margin: 0 auto;">
                    <img src="{{ asset('images/dental-chart.png') }}?v=3" alt="Dental Chart" class="w-full h-auto select-none pointer-events-none" draggable="false">
