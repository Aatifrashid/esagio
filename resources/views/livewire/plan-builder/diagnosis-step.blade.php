            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm"
                ...
                @php
                    $toothHotspots = [
                        ...
                        '48' => ['left' => '9.69%', 'top' => '47.5%', 'width' => '5.62%', 'height' => '18.5%', 'clip' => 'polygon(15% 7%, 25% 7%, 30% 28%, 42% 28%, 48% 7%, 52% 7%, 58% 28%, 70% 28%, 75% 7%, 85% 7%, 92% 28%, 96% 48%, 96% 80%, 92% 85%, 8% 85%, 4% 80%, 4% 48%, 8% 28%)'],
                        '47' => ['left' => '16.43%', 'top' => '47.5%', 'width' => '5.48%', 'height' => '18.5%', 'clip' => 'polygon(15% 7%, 25% 7%, 30% 28%, 42% 28%, 48% 7%, 52% 7%, 58% 28%, 70% 28%, 75% 7%, 85% 7%, 92% 28%, 96% 48%, 96% 80%, 92% 85%, 8% 85%, 4% 80%, 4% 48%, 8% 28%)'],
                        '46' => ['left' => '23.17%', 'top' => '47.5%', 'width' => '5.62%', 'height' => '18.5%', 'clip' => 'polygon(15% 7%, 25% 7%, 30% 28%, 42% 28%, 48% 7%, 52% 7%, 58% 28%, 70% 28%, 75% 7%, 85% 7%, 92% 28%, 96% 48%, 96% 80%, 92% 85%, 8% 85%, 4% 80%, 4% 48%, 8% 28%)'],
                        '45' => ['left' => '29.92%', 'top' => '47.5%', 'width' => '3.93%', 'height' => '18.5%', 'clip' => 'polygon(28% 5%, 40% 5%, 48% 20%, 52% 20%, 60% 5%, 72% 5%, 82% 30%, 86% 55%, 86% 76%, 80% 82%, 20% 82%, 14% 76%, 14% 55%, 18% 30%)'],
                        '44' => ['left' => '34.97%', 'top' => '47.5%', 'width' => '3.65%', 'height' => '18.5%', 'clip' => 'polygon(28% 5%, 40% 5%, 48% 20%, 52% 20%, 60% 5%, 72% 5%, 82% 30%, 86% 55%, 86% 76%, 80% 82%, 20% 82%, 14% 76%, 14% 55%, 18% 30%)'],
                        '43' => ['left' => '39.61%', 'top' => '47.5%', 'width' => '3.51%', 'height' => '18.5%', 'clip' => 'polygon(38% 3%, 50% 3%, 62% 3%, 72% 22%, 78% 42%, 78% 68%, 72% 76%, 28% 76%, 22% 68%, 22% 42%, 28% 22%)'],
                        '42' => ['left' => '44.10%', 'top' => '47.5%', 'width' => '2.95%', 'height' => '18.5%', 'clip' => 'polygon(30% 5%, 45% 5%, 55% 5%, 70% 5%, 78% 25%, 82% 50%, 82% 68%, 76% 76%, 24% 76%, 18% 68%, 18% 50%, 22% 25%)'],
                        '41' => ['left' => '47.89%', 'top' => '47.5%', 'width' => '2.81%', 'height' => '18.5%', 'clip' => 'polygon(30% 5%, 45% 5%, 55% 5%, 70% 5%, 78% 25%, 80% 50%, 80% 68%, 74% 76%, 26% 76%, 20% 68%, 20% 50%, 22% 25%)'],
                        '31' => ['left' => '52.11%', 'top' => '47.5%', 'width' => '2.81%', 'height' => '18.5%', 'clip' => 'polygon(30% 5%, 45% 5%, 55% 5%, 70% 5%, 78% 25%, 80% 50%, 80% 68%, 74% 76%, 26% 76%, 20% 68%, 20% 50%, 22% 25%)'],
                        '32' => ['left' => '55.76%', 'top' => '47.5%', 'width' => '2.95%', 'height' => '18.5%', 'clip' => 'polygon(30% 5%, 45% 5%, 55% 5%, 70% 5%, 78% 25%, 82% 50%, 82% 68%, 76% 76%, 24% 76%, 18% 68%, 18% 50%, 22% 25%)'],
                        '33' => ['left' => '59.69%', 'top' => '47.5%', 'width' => '3.37%', 'height' => '18.5%', 'clip' => 'polygon(38% 3%, 50% 3%, 62% 3%, 72% 22%, 78% 42%, 78% 68%, 72% 76%, 28% 76%, 22% 68%, 22% 42%, 28% 22%)'],
                        '34' => ['left' => '64.04%', 'top' => '47.5%', 'width' => '3.79%', 'height' => '18.5%', 'clip' => 'polygon(28% 5%, 40% 5%, 48% 20%, 52% 20%, 60% 5%, 72% 5%, 82% 30%, 86% 55%, 86% 76%, 80% 82%, 20% 82%, 14% 76%, 14% 55%, 18% 30%)'],
                        '35' => ['left' => '68.82%', 'top' => '47.5%', 'width' => '3.93%', 'height' => '18.5%', 'clip' => 'polygon(28% 5%, 40% 5%, 48% 20%, 52% 20%, 60% 5%, 72% 5%, 82% 30%, 86% 55%, 86% 76%, 80% 82%, 20% 82%, 14% 76%, 14% 55%, 18% 30%)'],
                        '36' => ['left' => '74.02%', 'top' => '47.5%', 'width' => '5.48%', 'height' => '18.5%', 'clip' => 'polygon(15% 7%, 25% 7%, 30% 28%, 42% 28%, 48% 7%, 52% 7%, 58% 28%, 70% 28%, 75% 7%, 85% 7%, 92% 28%, 96% 48%, 96% 80%, 92% 85%, 8% 85%, 4% 80%, 4% 48%, 8% 28%)'],
                        '37' => ['left' => '80.76%', 'top' => '47.5%', 'width' => '5.48%', 'height' => '18.5%', 'clip' => 'polygon(15% 7%, 25% 7%, 30% 28%, 42% 28%, 48% 7%, 52% 7%, 58% 28%, 70% 28%, 75% 7%, 85% 7%, 92% 28%, 96% 48%, 96% 80%, 92% 85%, 8% 85%, 4% 80%, 4% 48%, 8% 28%)'],
                        '38' => ['left' => '87.50%', 'top' => '47.5%', 'width' => '5.62%', 'height' => '18.5%', 'clip' => 'polygon(15% 7%, 25% 7%, 30% 28%, 42% 28%, 48% 7%, 52% 7%, 58% 28%, 70% 28%, 75% 7%, 85% 7%, 92% 28%, 96% 48%, 96% 80%, 92% 85%, 8% 85%, 4% 80%, 4% 48%, 8% 28%)'],
                    ];
                @endphp
                    ...
                    @if(count($selectedConditions) > 0)
                        <div class="flex flex-wrap gap-1.5 mb-4">
                            @foreach($selectedConditions as $sc)
                                ...
                                @endphp
                                <span class="inline-flex items-center gap-0.5 text-[7px] font-medium pl-1 pr-0.5 py-px rounded-full text-white leading-tight" style="background-color: {{ $condColour }}">
                                    <span class="opacity-70">#{{ $uniNum }}</span> {{ Str::limit($condLabel, 10) }}
