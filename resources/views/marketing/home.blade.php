...
<section class="relative bg-navy text-white overflow-hidden">
    <div class="absolute inset-0 opacity-5">
        <div class="absolute inset-0" style="background-image: radial-gradient(circle at 20% 50%, #E8663D 0%, transparent 50%), radial-gradient(circle at 80% 20%, #0A2640 0%, transparent 50%);"></div>
    </div>
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div class="max-w-3xl">
            <div class="inline-flex items-center gap-2 bg-white/10 rounded-full px-4 py-1.5 text-sm mb-6 border border-white/10">
                <span class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></span>
                Now with built-in CRM. No Salesforce bolt-on required.
            </div>
            <h1 class="font-display text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight mb-6">
                Treatment plans that <span class="text-accent">close more cases</span>
            </h1>
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <a href="/demo" class="btn btn-slate btn-lg">
...
<section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="font-display text-4xl font-bold text-navy tracking-tight mb-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="p-6 rounded-[5px] border border-gray-100 hover:shadow-lg transition">
                <div class="w-12 h-12 bg-accent-50 rounded-[5px] flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                </div>
                <h3 class="font-bold text-lg text-gray-900 mb-2">Treatment Plan Builder</h3>
            ...
            <div class="p-6 rounded-[5px] border border-gray-100 hover:shadow-lg transition">
                ...
                <h3 class="font-bold text-lg text-gray-900 mb-2">CRM Built In</h3>
                <p class="text-gray-600 text-sm leading-relaxed">
            ...
            <div class="p-6 rounded-[5px] border border-gray-100 hover:shadow-lg transition">
                <div class="w-12 h-12 bg-green-50 rounded-[5px] flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.069A1 1 0 0121 8.87v6.26a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                    </svg>
                </div>
                <h3 class="font-bold text-lg text-gray-900 mb-2">Video Consultations</h3>
                <p class="text-gray-600 text-sm leading-relaxed">
...
<section class="py-24 bg-gray-50">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="font-display text-4xl font-bold text-navy tracking-tight mb-4">Simple, honest pricing</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-[5px] border {{ $tier['highlight'] ? 'border-accent shadow-lg' : 'border-gray-200' }} p-6 text-center relative">
                @if($tier['highlight'])
                ...
                <div class="font-display text-3xl font-bold text-navy mb-1 tracking-tight">{{ $tier['price'] }}<span class="text-sm font-normal text-gray-500 font-sans">/mo</span></div>
                <div class="text-sm text-gray-600 mb-4">{{ $tier['plans'] }}</div>
                <a href="/pricing" class="text-sm text-accent font-medium hover:underline">See all features</a>
            </div>
            @endforeach
        </div>

        <div class="text-center mt-8">
            <a href="/pricing" class="inline-flex items-center gap-2 text-navy font-medium hover:underline">
                Compare all plans
...
<section class="py-24 bg-white">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="font-display text-4xl font-bold text-navy tracking-tight mb-4">Common questions</h2>
        </div>
...
<section class="bg-navy text-white py-24">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="font-display text-4xl font-extrabold tracking-tight mb-4">
