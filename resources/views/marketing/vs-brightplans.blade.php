...
<section class="bg-navy text-white py-20">
    <div class="max-w-3xl mx-auto px-4 text-center">
        <h1 class="font-display text-5xl font-extrabold tracking-tight mb-4">Esagio vs BrightPlans</h1>
...
<section class="py-20 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-10 p-6 bg-accent-50 border border-accent-100 rounded-[5px] text-center">
            <p class="text-navy font-medium text-lg">
                The average clinic switching from BrightPlans saves <strong>£720+ per year</strong>.
            </p>
        </div>

        <div class="bg-white rounded-[5px] border border-gray-200 overflow-hidden shadow-sm">
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-200">
                            <th class="text-left px-6 py-4 text-gray-500 font-medium w-2/5">Feature</th>
                            <th class="text-center px-6 py-4 text-accent font-bold text-base">Esagio</th>
        ...
        {{-- Migration CTA --}}
        <div class="mt-16 bg-navy rounded-[5px] p-10 text-white text-center">
            <h2 class="font-display text-3xl font-extrabold tracking-tight mb-3">Ready to make the switch?</h2>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/register" class="btn btn-primary">Start your free account</a>
                <a href="/contact" class="btn btn-slate">Talk to migration team</a>
            </div>
        </div>
    </div>
</section>
