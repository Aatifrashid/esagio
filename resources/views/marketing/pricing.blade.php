...
<section class="py-20 bg-gray-50">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
            ...
            <div class="bg-white rounded-2xl border {{ $tier['highlight'] ? 'border-2 border-[#E8663D] shadow-xl' : 'border-gray-200 shadow-sm' }} p-6 relative">
                @if($tier['highlight'])
                <div class="absolute -top-4 left-0 right-0 flex justify-center">
                    <span class="bg-[#E8663D] text-white text-xs font-bold px-4 py-1 rounded-full">Most Popular</span>
                </div>
                @endif
                <h3 class="font-bold text-lg text-gray-900 mb-1">{{ $tier['name'] }}</h3>
                ...
                <a href="/register" class="block w-full text-center py-2.5 rounded-xl font-medium text-sm transition
                    {{ $tier['highlight'] ? 'bg-[#E8663D] text-white hover:bg-[#E8663D]/90' : 'bg-[#0A2540] text-white hover:bg-[#0A2540]/90' }}">
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-gray-100">
                            ...
                            <th class="text-center px-4 py-3 text-[#E8663D] font-semibold">Professional</th>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 py-3 text-center text-[#E8663D] font-medium">{{ $row[3] ?: '' }}</td>
...
<section class="py-20 bg-white">
    <div class="max-w-3xl mx-auto px-4">
        <h2 class="font-['Fraunces'] text-3xl font-bold text-[#0A2540] mb-10 text-center">Questions about pricing</h2>
